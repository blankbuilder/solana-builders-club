...
// Tiny crosshair graphic for grid intersections
...
export default function HomePage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col font-sans overflow-x-clip">
      ...
      {/* Outer wrapper to contain everything in the grid */}
      <div className="mx-auto w-full max-w-6xl sm:border-x-[0.5px] border-white/10 flex flex-col flex-1 relative">
        ...
        <main className="w-full flex-1 flex flex-col relative">
          ...
          <div className="w-full bg-[--color-panel]/50 relative border-b-[0.5px] border-white/10">
        ...
        {/* Bottom Corner Crosshairs for the entire container */}
...
function SectionHeader({ current, total, title }: { current: string, total: string, title: string }) {
  return (
